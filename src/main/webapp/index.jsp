...
<head>
    ...
    <title>NexusShop — Modern E‑Commercesssssssssssssssssssssssssssssssssssssssssssssssssssssssss</title>
...
<body>
    ...
    <main>
        ...
        <section class="hero" role="img" aria-label="Hero banner">
            <div class="container">
                <h1>winter and summerrrrrru 2 secle sollection — Premium Picks BY Sai Pola</h1>
